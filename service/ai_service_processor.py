...
class AIProcessor():
    ...
    def provide_guidence_process(self, user_data: UserDataForGuidence, parser: JsonOutputParser):
        ...
        prompt = PromptTemplate(
            ...
            input_variables=["current_week", "chatbot_interaction", "emotion_tracking", "context"],
    ...
    def load_or_create_faiss_index(self):
        if os.path.exists(FAISS_INDEX_PATH):
            ...
            vector_store = FAISS.load_local(cfg["FAISS_INDEX_PATH"], OpenAIEmbeddings(), allow_dangerous_deserialization=True)
        else:
            ...
            vector_store.save_local(FAISS_INDEX_PATH)  # Save to disk for future use
